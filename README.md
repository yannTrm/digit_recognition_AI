...
- à noter que je veux propose un petit dataset dans le dossier dataset, mais un dataset complet est disponible à l'adresse `https://www.kaggle.com/terromyann/datasets`
